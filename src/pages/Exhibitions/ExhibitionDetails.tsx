...
const ExhibitionDetails = () => {
	...
	return (
		<article className='exhibition-details px-4'>
			<Container>
				<Link to='/map'>
					...
					<Stack gap={4} ref={exhibition} id='exhibition'>
						...
						<div className='hidden-y-top'>
							...
							<p className='exhibition-details__description'>
								Lorem ipsum dolor sit amet, consectetur adipisicing elit. Modi placeat vitae rem earum sunt quaerat,
								doloremque aliquam inventore. Architecto fuga ex molestiae illo nemo harum tenetur repudiandae labore
								consequuntur inventore, ab dolorum reiciendis sed accusantium commodi ratione sequi at hic libero, et
								ducimus. Non, omnis inventore perspiciatis velit natus expedita.
							</p>
						</div>
