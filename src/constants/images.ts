...
import bernadetta_kazmierczak from "../assets/images/speakers/bernadetta_kazmierczak.jpg";
import andrzej_puchalski from "../assets/images/speakers/andrzej_puchalski.webp";
...
const speakers: Speaker[] = [
  {
    ...
    lectures: [
      "Wprowadzenie - co ja tutaj robię? (Prowadzący)",
      "Wiedzomania",
      "Pora na działanie",
    ],
  ...
  {
    id: "ap-speaker",
    name: "dr hab. inż. Andrzej Puchalski, prof. URad.",
    desc: "Dziekan Wydziału Mechanicznego",
    lectures: ["Inżynier to jest ktoś!"],
    link: "https://wm.uniwersytetradom.pl/wladze/",
    photo: andrzej_puchalski,
  },
  ...
  {
    id: "ks-speaker",
    name: "dr hab. inż. Krzysztof Śmiechowski, prof. URad.",
  ...
  {
    id: "bk-speaker",
    name: "dr inż. Bernadetta Kaźmierczak",
    desc: "Wywiad z dr inż. Bernadettą Kaźmierczak (absolwentką Uniwersytetu Radomskiego, pracownikiem naukowym Łukasiewicz – IteE).",
    lectures: ["Jak zostać kimś, kto cieszy się tym co robi?"],
    link: "https://www.itee.lukasiewicz.gov.pl/obszary/centrum-badan-edukacji-zawodowej-i-zarzadzania-innowacjami",
    photo: bernadetta_kazmierczak,
  },
