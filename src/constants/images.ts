...
import gmina_radom from "../assets/images/gmina_Radom.png";
...
const partners = [
  {
    img: gmina_radom,
    alt: "Herb miasta Radom",
    name: "Gmina Miasta Radom",
    link: "https://bip.radom.pl/",
  },
  {
    img: not,
    alt: "Logo Federacji Stowarzyszeń Naukowo-Technicznych Naczelnej Organizacji Technicznej",
    name: "Radomska Rada FSNT-NOT",
    link: "https://radom.enot.pl/",
  },
  {
    img: ite,
    alt: "Logo Sieci Badawczej Łukasiewicz - Instytut Technologii Eksploatacji",
    name: "Sieć Badawcza Łukasiewicz - Instytut Technologii Eksploatacji",
    link: "https://www.itee.lukasiewicz.gov.pl/",
  },
  {
    img: tim,
    alt: "Tomasz Magnowski",
    name: "TiM Tomasz Magnowski",
    link: "https://pl.linkedin.com/in/tomasz-magnowski-74950340",
  },
  {
    img: ur,
    alt: "Logo Uniwersytet Radomski",
    name: "Uniwersytet Radomski",
